...
% Customização da classe abnTeX2 (http://www.abntex.net.br/) para as normas da UNOPAR
%
% Projeto hospedado em: <https://github.com/wborbajr/latex-unopar>
% Autores: Waldir Borba Junior  <wborbajr@gmail.com>
%
%----------------------------------------------------------------------------------------------------------------
% Codificação: UTF-8
% LaTeX:  abnTeX2          
